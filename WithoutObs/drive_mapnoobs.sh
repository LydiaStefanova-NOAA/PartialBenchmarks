...
# The script is  prepared to handle variables on the list below 
    ...
    for varname in cloudmid cloudlow cloudhi ; do
    ...
    #for varname in pres dlwrf dswrf ulwrf uswrf cloudbdry cloudlow cloudmid cloudhi shtfl lhtfl; do
      ...
      #          bash  map_compare_noobs_polar.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=14 d2=27 whereexp=$whereexp
      #          bash  map_compare_noobs_polar.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=0 d2=0 whereexp=$whereexp
      #          bash  map_compare_noobs_polar2.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=10 d2=19 whereexp=$whereexp
      #          bash  map_compare_noobs_polar2.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=20 d2=34 whereexp=$whereexp
      #      done
      #  done
        for domain in Global  ; do    
            for season in DJF JJA MAM SON AllAvailable ; do
                echo "Attempting $domain $season $varname "
            #for season in AllAvailable ; do
                ...
                bash  map_compare_noobs.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=0 d2=6 whereexp=$whereexp
                bash  map_compare_noobs.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=7 d2=13 whereexp=$whereexp
                bash  map_compare_noobs.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=14 d2=20 whereexp=$whereexp
                bash  map_compare_noobs.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=21 d2=27 whereexp=$whereexp
                #bash  map_compare_noobs.sh varModel=$varname domain=$domain hardcopy=$hardcopy season=$season nameModelA=$exp1 nameModelB=$exp2 d1=14 d2=27 whereexp=$whereexp
            done
        done
    done
